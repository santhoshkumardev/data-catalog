# data-catalog
data catalog tool to explore &amp; document metadata
...
A user submits a change request with proposed modifications (stored as JSON)
A steward reviews the request and approves or rejects it with a comment
The full workflow is captured in the audit log
